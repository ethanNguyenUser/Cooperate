...
const GAME_CONFIG = {
  ...
  function toggleMusic(){ const on = AudioSys.toggle(); document.getElementById('muteBtn').textContent = on? '🔊 Sound' : '🔇 Sound'; if(on){ AudioSys.playMusic(Game.levelIndex); } else { AudioSys.stopMusic(); } }
  ...
  function updateCooperativeHUD(){
    ...
    combinedLabel.textContent = '💥 Combined Attack (Space)';
